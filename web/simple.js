...
// User configurable.
const ROM_FILENAME = 'snailmail.gbc';
...
(async function go() {
  ...
  if (!response.ok) {
    document.body.textContent = 'Failed to load ROM: ' + ROM_FILENAME;
    return;
  }
...
class Emulator {
  ...
  bindKeys() {
    // GB Studio defaults (project/settings.gbsres customControls*).
    this.keyFuncs = {
      ...
      'AltLeft': this.setJoypA.bind(this),
      'AltRight': this.setJoypA.bind(this),
      'KeyX': this.setJoypB.bind(this),
      'KeyK': this.setJoypB.bind(this),
      'ControlLeft': this.setJoypB.bind(this),
      'ControlRight': this.setJoypB.bind(this),
      'Enter': this.setJoypStart.bind(this),
      'ShiftLeft': this.setJoypSelect.bind(this),
